				...
				<Grid container>
					<Grid items xs={12} lg={4}>
						<Paper className="d-cards d-card-maroon">
							<h3>{dashboardData && dashboardData.data.count}<br></br>Transaction</h3>
							<ReceiptOutlinedIcon  filter= "brightness(90%)" style={{ fontSize: 70 }}/>
						</Paper>
					</Grid>
					<Grid items xs={12} lg={4}>
						<Paper className="d-cards d-card-indigo">
							<h3>{dashboardData && dashboardData.data.qty}<br></br>Products</h3>
							<AccountBalanceWalletOutlinedIcon filter= "brightness(90%)" style={{ fontSize: 70 }}/>
						</Paper>
					</Grid>
					<Grid items xs={12} lg={4}>
						<Paper className="d-cards d-card-orange">
							<h3>
								${Math.round(dashboardData && dashboardData.data.total, 2)} <br></br>Income
							</h3>
							<LocalAtmOutlinedIcon filter= "brightness(90%)" style={{ fontSize: 70 }}/>
						</Paper>
					</Grid>
				</Grid>
				<Grid container>
					...
					<Grid item lg={6} sm={12}>
						<Paper>
							...
							<Table className={classes.table} aria-label="simple table">	
								<TableHead>
									<TableRow >
										<TableCell ><h5>Reciept no</h5></TableCell>
